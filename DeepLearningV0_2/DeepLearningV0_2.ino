...
//const int numNodes = numInput + numOutput + numHidden;
//const int memDepth = 2;
//
//float x[numNodes][memDepth];
////float Oldx[numNodes] = {1,1,1,1,1,1};
//float u[numNodes][memDepth];
////float Oldu[numNodes] = {1,1,1,1,1,1};
...
//  PitchPID.SetOutputLimits(1150,1400);
...
//      updateSetpoint((float)Setpoint);
//      updatePosition(Input);
//    
//      calculateInputOfNeurons();
//      calculateOutputOfNeurons();
//      updateWeights();
    }
  }

  Output = PitchNN.Output()*30+1220;
//  Output = x[5][0]*30+1220;
