...
void NNPID::updateWeights()
{
  ...
  w[0] = w[0] - _LearnRate*x[0][0]*tanhPrime(u[0][0])*(w[0]*tanhPrime(u[2][0])*w[6]*(Setpoint-Position));                                                    
  w[1] = w[1] - _LearnRate*x[0][0]*tanhPrime(u[0][0])*(w[1]*tanhPrime(u[3][0])*w[7]*(Setpoint-Position));
  w[2] = w[2] - _LearnRate*x[0][0]*tanhPrime(u[0][0])*(w[2]*tanhPrime(u[4][0])*w[8]*(Setpoint-Position));
  
  w[3] = w[3] - _LearnRate*x[1][0]*tanhPrime(u[1][0])*(w[3]*tanhPrime(u[2][0])*w[6]*(Setpoint-Position));
  w[4] = w[4] - _LearnRate*x[1][0]*tanhPrime(u[1][0])*(w[4]*tanhPrime(u[3][0])*w[7]*(Setpoint-Position));
  w[5] = w[5] - _LearnRate*x[1][0]*tanhPrime(u[1][0])*(w[5]*tanhPrime(u[4][0])*w[8]*(Setpoint-Position));
}
