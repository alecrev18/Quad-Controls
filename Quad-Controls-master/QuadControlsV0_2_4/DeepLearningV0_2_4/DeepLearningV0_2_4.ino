...
PID PitchPID(&kalAngleX, &PIDout[0], &Setpoint[0],1.55,0.009,0, DIRECT);
PID RollPID(&kalAngleY, &PIDout[1], &Setpoint[1],1.55,0.009,0, DIRECT);
//PID YawPID(&Input[2], &Output[2], &Setpoint[2],5,0.5,0, DIRECT);

String streamRead = "";

NNPID PitchNN(0.4,PIDout[0]);
NNPID RollNN(0.4,PIDout[1]);
//NNPID YawNN(0.4,PIDout[2]);
...
//  Setpoint[0] = channel1;   These need to be scaled to degrees before we use this
//  Setpoint[1] = channel2;
//  Setpoint[2] = channel4; I think these are right...
//  throttle = channel3;
